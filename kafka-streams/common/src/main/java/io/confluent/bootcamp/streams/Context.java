...
public class Context {
    static private final Map<String, String> configuration = new HashMap<>();
    ...
    public static String getDLQTopic() {
        return dlqTopic;
    }

    public static void setDLQTopic(String dlqTopic) {
        Context.dlqTopic = dlqTopic;
    }
}
